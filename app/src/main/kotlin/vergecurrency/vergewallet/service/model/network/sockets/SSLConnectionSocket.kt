...
class SSLConnectionSocket(sslContext: SSLContext) : SSLConnectionSocketFactory(sslContext) {
    ...
    override fun connectSocket(connectTimeout: Int, socket: Socket, host: HttpHost, remoteAddress: InetSocketAddress,
                               localAddress: InetSocketAddress, context: HttpContext): Socket {
