...
public class GetStartedActivity extends AppCompatActivity {
    ...
    private void instantiateView() {
        ...
        subTextView = findViewById(R.id.launch_verge_sub);
        ...
        bottomChargingView = findViewById(R.id.launch_bottom_text);
        bottomChargingView.setVisibility(View.GONE);
        //show "Create or restore a wallet" layout
        bottomChargingView = findViewById(R.id.launch_bottom_firstlaunch);
